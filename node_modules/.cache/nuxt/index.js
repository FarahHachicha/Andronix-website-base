...
import nuxt_plugin_plugin_3b49485e from 'nuxt_plugin_plugin_3b49485e' // Source: ./components/plugin.js (mode: 'all')
import nuxt_plugin_sentryserver_bc533daa from 'nuxt_plugin_sentryserver_bc533daa' // Source: ./sentry.server.js (mode: 'server')
import nuxt_plugin_sentryclient_3c1cefa3 from 'nuxt_plugin_sentryclient_3c1cefa3' // Source: ./sentry.client.js (mode: 'client')
import nuxt_plugin_recaptcha_5d8ffb56 from 'nuxt_plugin_recaptcha_5d8ffb56' // Source: ./recaptcha.js (mode: 'all')
import nuxt_plugin_axios_81580f32 from 'nuxt_plugin_axios_81580f32' // Source: ./axios.js (mode: 'all')
import nuxt_plugin_vuescrollto_f47dc87c from 'nuxt_plugin_vuescrollto_f47dc87c' // Source: ./vue-scrollto.js (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_3b49485e === 'function') {
    await nuxt_plugin_plugin_3b49485e(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_sentryserver_bc533daa === 'function') {
    await nuxt_plugin_sentryserver_bc533daa(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_sentryclient_3c1cefa3 === 'function') {
    await nuxt_plugin_sentryclient_3c1cefa3(app.context, inject)
  }

  if (typeof nuxt_plugin_recaptcha_5d8ffb56 === 'function') {
    await nuxt_plugin_recaptcha_5d8ffb56(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_81580f32 === 'function') {
    await nuxt_plugin_axios_81580f32(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_vuescrollto_f47dc87c === 'function') {
    await nuxt_plugin_vuescrollto_f47dc87c(app.context, inject)
  }
